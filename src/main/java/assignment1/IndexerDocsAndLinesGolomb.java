...
public class IndexerDocsAndLinesGolomb {
  ...
  public static void main(String[] args) throws Exception {
    ...
    //FileOutputFormat.setOutputPath(job, new Path("s3://in4325-enwiki/output/be_ka_zi/golomb/"));
    job.setInputFormatClass(XmlInputFormat.class);
    job.setJarByClass(IndexerDocsAndLinesGolomb.class);
